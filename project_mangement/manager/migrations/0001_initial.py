    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('req_skills', models.ManyToManyField(related_name='projects', to='manager.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('status', models.CharField(choices=[('todo', 'To Do'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('due', 'Due')], default='todo', max_length=20)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='manager.addproject')),
                ('required_skills', models.ManyToManyField(related_name='tasks', to='manager.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='time_logs', to='manager.task')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('junior', 'Junior'), ('mid', 'Mid-Level'), ('senior', 'Senior')], default='junior', max_length=10)),
                ('preferred_roles', models.ManyToManyField(blank=True, related_name='users', to='manager.role')),
                ('skills', models.ManyToManyField(related_name='users', to='manager.skill')),
